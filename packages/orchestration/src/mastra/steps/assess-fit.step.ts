...
import { generateObject } from '@mastra/core/dist/_types/@internal_ai-v6/dist';
...
export const assessFit = createStep({
	id: 'assess-fit',
	description: 'Assess the fit of the model to the data',
