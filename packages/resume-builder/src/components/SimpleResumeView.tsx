...
const SimpleSection: FC<SimpleSectionProps> = ({ title, actions, children, id, path }) => {
	const section = (
		...
		<div className="simple-resume-shell">
			<header id={RESUME_SECTION_IDS.contactInformation} className="simple-resume-hero">
				<div className="simple-resume-identity">
					...
					/>
					<HighlightRegion path="data.title" label="Professional title">
						<span>
							<TextFieldEditor
								path="data.title"
								value={resume.title}
...
const EducationSection: FC = () => {
	...
	return (
		<SimpleSection title="Education" id={RESUME_SECTION_IDS.education} path="data.education">
			{education.length === 0 ? (
...
const SkillsSection: FC = () => {
	...
	if (skillGroups && skillGroups.length > 0) {
		return (
			<SimpleSection title="Skills" id={RESUME_SECTION_IDS.skills} path="data.skillGroups">
	...
	if (skills && skills.length > 0) {
		return (
			<SimpleSection title="Skills" id={RESUME_SECTION_IDS.skills} path="data.skills">
