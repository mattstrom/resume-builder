			...
			<ModelSelectorTrigger asChild>
				<PromptInputButton>
					{selectedModelData?.logoProvider && (
						<ModelSelectorLogo provider={selectedModelData.logoProvider} />
					)}
					<ModelSelectorName>
			...
			<ModelSelectorContent>
				...
				<ModelSelectorList>
					...
					{modelGroups.map((group) => (
						<ModelSelectorGroup heading={group.providerLabel} key={group.providerLabel}>
...
const ModelItem = memo(({ model, selectedModel, onSelect }: ModelItemProps) => {
	...
	return (
		...
		>
			{model.logoProvider && <ModelSelectorLogo provider={model.logoProvider} />}
