...
export type PhoneNumberProperty = Extract<DatabasePropertyConfigResponse, { type: 'phone_number' }>;
...
export class PhoneNumberAdapter extends Adapter<PhoneNumberProperty, string> {
	...
	static is(property: DatabasePropertyConfigResponse): property is PhoneNumberProperty {
