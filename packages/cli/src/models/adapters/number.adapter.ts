...
export type NumberProperty = Extract<DatabasePropertyConfigResponse, { type: 'number' }>;
...
export class NumberAdapter extends Adapter<NumberProperty, number> {
	...
	static is(property: DatabasePropertyConfigResponse): property is NumberProperty {
