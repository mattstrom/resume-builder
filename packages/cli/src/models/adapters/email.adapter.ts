...
export type EmailProperty = Extract<DatabasePropertyConfigResponse, { type: 'email' }>;
...
export class EmailAdapter extends Adapter<EmailProperty, string> {
	...
	static is(property: DatabasePropertyConfigResponse): property is EmailProperty {
